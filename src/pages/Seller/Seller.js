...
const Seller = () => {
    ...
    const onUpload = () => {
        if (
            ...
            if (window.confirm("판매자 등록을 하시겠습니까?"))
                axios
                    .post(
                        url + "sellers",
                        {
    ...
    const onCancel = () => {
        if (
            window.confirm(
                "작성 중인 내용이 모두 삭제됩니다. 판매자 등록을 취소하시겠습니까?"
            )
        )
            navigate("/");
    };
        ...
        <Container>
            <Header>
                ...
                <Ul>
                    ...
                    <li>
                        판매자 등록이 완료되면 상품 판매 페이지에 상품을 등록할
                        수 있습니다.
                    </li>
                </Ul>
            </Header>
            ...
            <Footer>
                <Button width="150px" margin="0px 50px" onClick={onUpload}>
                    등록하기
                </Button>
                <Button width="150px" margin="0px 50px" onClick={onCancel}>
                    취소
                </Button>
            </Footer>
        </Container>
