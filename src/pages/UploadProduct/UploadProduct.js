...
const UploadProduct = () => {
    ...
    useEffect(() => {
        ...
        setCategoryValues({
            ...categoryValues,
            fourth: category4.current?.value,
        });
    }, [fourth]);
            ...
            <Content>
                        ...
                        <div>
                            ...
                            <Category
                                ...
                                {categories &&
                                    categories[first] &&
                                    categories[first].subCategories &&
                                    categories[first].subCategories.map(
                                        (data, idx) => (
                                            <option key={idx} value={data.name}>
                                                {data.name}
                                            </option>
                            ...
                            <Category
                                ...
                                value={
                                    fourth === null
                                        ...
                                        : categories[first].subCategories[
                                              second
                                          ].subCategories[third].subCategories[
                                              fourth
                                          ]?.name
                                }>
                                <option disabled value="default">
                                ...
                                {categories &&
                                    ...
                                    categories[first].subCategories[
                                        second
                                    ].subCategories[third].subCategories.map(
                                        (data, idx) => (
                                            <option key={idx} value={data.name}>
                                                {data.name}
                                            </option>
                ...
                <PreviewImgsContainer>
                    {previewImgs?.map((data, idx) => (
                        <div
                            style={{ position: "relative", margin: "0px 20px" }}
                            key={idx}>
                            <RemoveBtn
                                src={roundX}
                                alt="removeBtn"
