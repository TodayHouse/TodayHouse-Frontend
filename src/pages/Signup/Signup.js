...
import { changeAgree, handleVerify } from "../../redux/reducer/signup";
...
const Signup = () => {
    ...
    // 이메일 인증 여부
    const isVerified = useSelector((state) => state.signup.isVerified);
            ...
            //이메일 중복 아닐 경우
                ...
                if (emailCheckMsg === "") {
                    if (form.email === "") alert("이메일을 입력해주세요.");
                        ...
                        axios
                            .post(
                                "http://localhost:8080/" + "emails/token/send",
                                data,
                                {
                                    headers: {
    ...
    const pEqualR = () => {
        return (
            form.password === form.repassword || form.repassword.length === 0
        );
    };
            ...
            <Container>
                ...
                <SignupContainer>
                    ...
                    <EmailContainer>
                        ...
                        <EmailVerifyView
                            email={form.email + "@" + form.emailSuffix}
                        />
                    </EmailContainer>
                    <PasswordContainer>
                        <Label style={{ color: textColor.password }}>
                            비밀번호
                        </Label>
                        <Password>
                            <Description>
                    ...
                    <PasswordCheckContainer>
                        <Label style={{ color: textColor.repassword }}>
                            비밀번호 확인
                        </Label>
                        <PasswordCheck>
                            <Input
                    ...
                    <NicknameContainer>
                        <Label style={{ color: textColor.nickname }}>
                            닉네임
                        </Label>
                        <Nickname>
                            <Description>
...
const EmailButton = styled.button`
    ...
    box-sizing: border-box;
    border: 2px solid
        ${(props) => (props.disabled ? "#cccccc" : props.theme.mainColor)};
    border-radius: 8px;
    color: ${(props) => (props.disabled ? "#cccccc" : props.theme.mainColor)};
    font-size: 20px;
    font-weight: bold;
    padding: 12px 16px;
    &:hover {
        background-color: ${(props) => (props.disabled ? "" : "#e6f4ff")};
    }
`;
